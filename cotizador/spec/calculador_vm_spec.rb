...
describe 'Calculador del valor de mercado' do
  ...
  it 'recibe 1 de ci y 1000 de km y devuelve 800.0' do
    expect(calculador_vm.calcular(1, 1000)).to eq 500.0
  end

  it 'recibe 2 de ci y 1000 de km y devuelve 1000.0' do
    expect(calculador_vm.calcular(2, 1000)).to eq 1000.0
  end

  it 'recibe 2 de ci y 1500 de km y devuelve 800.0' do
    expect(calculador_vm.calcular(2, 1500)).to eq 800.0
  end

  it 'recibe 2 de ci y 2000 de km y devuelve 666.6' do
